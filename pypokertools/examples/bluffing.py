...
from pypokertools.properties import is_3flush, is_3straight, is_onepair
from pypokertools.properties import is_twopair_or_better as hand_is_twopair_or_better
...
def is_bluffcandidate(holecards, flop):
    ...
    Example:
        >>> from pypokertools.pokertools import holecards, flop
